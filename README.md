...
- `wgen_input_example.zip` contains an example set of input data. To test WGEN, extract the contents from this zip folder and place them into the base folder of this repository, replacing any duplicate files.
